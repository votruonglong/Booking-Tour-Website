...
export const getScheduleByTour = createAsyncThunk(
    "schedule/getScheduleByTour",
    async (id, { rejectWithValue }) => {
        try {
            const response = await getRequest(`/schedule/GetScheduleByTourId/${id}`);
            return response.data;
        } catch (error) {
            return rejectWithValue(error.response.data);
        }
...
const scheduleSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getScheduleByTour.pending, (state) => {
                state.status = "loading";
            })
